...
namespace ListaMascota
{
    ...
    {
        List<ClsMenu> MiLista = new List<ClsMenu>();
        ...
        {
            foreach (ClsMenu miMascota in MiLista) 
            {
        ...
        private void tslConsultar_Click(object sender, EventArgs e)
        {
            ...
            ClsMenu miMascota = GetMascota(txtNombre.Text);
            if (miMascota == null)
            {
        ...
        private ClsMenu GetMascota(string nombre)
        {
